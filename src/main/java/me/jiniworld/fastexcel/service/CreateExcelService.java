...
public class CreateExcelService {
  ...
  public void createExcel3() {
    ...
    try (OutputStream os = new FileOutputStream("output3.xlsx");
      ...
      ExcelTableUtils.applyTd(ws, 6, 1, 1, 3, content.data14(), CustomStyle.style4());
      ...
      ExcelTableUtils.applyTh(ws, 7, 0, 1, TOTAL_COL_SIZE, title.title17());
      ExcelTableUtils.applyTd(ws, 8, 0, 1, TOTAL_COL_SIZE, content.data17(), CustomStyle.style1());
      ExcelTableUtils.applyTd(ws, 9, 0, 1, TOTAL_COL_SIZE, content.data17(), CustomStyle.style1());
      ExcelTableUtils.applyTd(ws, 10, 0, 1, TOTAL_COL_SIZE, content.data17(), CustomStyle.style2());
      ExcelTableUtils.applyTd(ws, 11, 0, 1, TOTAL_COL_SIZE, content.data17(), CustomStyle.style3());

      ExcelTableUtils.applyTh(ws, 12, 0, 1, TOTAL_COL_SIZE, title.title18());
