...
public class CreateExcelService {
  ...
  public void createExcel4() {
    ...
    try (OutputStream os = new FileOutputStream("output4.xlsx");
      ...
      ExcelTableUtils.applyTh(ws, 2, 0, 1, 1, title.title3());
      ExcelTableUtils.applyTd(ws, 2, 1, 1, 7, content.data3());

      ExcelTableUtils.applyTh(ws, 3, 0, 1, 1, title.title4());
      ExcelTableUtils.applyTd(ws, 3, 1, 1, 3, content.data4());
      ExcelTableUtils.applyTh(ws, 3, 4, 1, 1, title.title5());
      ExcelTableUtils.applyTd(ws, 3, 5, 1, 3, content.data5());

      ExcelTableUtils.applyTh(ws, 4, 0, 1, 1, title.title6());
      ExcelTableUtils.applyTd(ws, 4, 1, 1, 3, content.data6());
      ExcelTableUtils.applyTh(ws, 4, 4, 1, 1, title.title7());
      ExcelTableUtils.applyTd(ws, 4, 5, 1, 3, content.data7());
      ...
      ExcelTableUtils.applyCustomTd(ws, 6, 1, 1, 3, content.data10(), CustomStyle.style4());
      ExcelTableUtils.applyTh(ws, 6, 4, 1, 1, title.title11());
      ExcelTableUtils.applyTd(ws, 6, 5, 1, 1, content.data11());
      ExcelTableUtils.applyTh(ws, 6, 6, 1, 1, title.title12());
      ExcelTableUtils.applyTd(ws, 6, 7, 1, 1, content.data12());

      ExcelTableUtils.applyTh(ws, 7, 0, 1, totalColSize, title.title13());
      ExcelTableUtils.applyCustomTd(
          ws, 8, 0, 1, totalColSize, content.data13(), CustomStyle.style1());
      ExcelTableUtils.applyCustomTd(
          ws, 9, 0, 1, totalColSize, content.data13(), CustomStyle.style1());
      ExcelTableUtils.applyCustomTd(
          ws, 10, 0, 1, totalColSize, content.data13(), CustomStyle.style2());
      ExcelTableUtils.applyCustomTd(
          ws, 11, 0, 1, totalColSize, content.data13(), CustomStyle.style3());

      ExcelTableUtils.applyTh(ws, 12, 0, 1, 8, title.title14());
      ExcelTableUtils.applyTd(ws, 13, 0, 1, 1, title.title15());
      ExcelTableUtils.applyTd(ws, 13, 1, 1, 2, null);
      ExcelTableUtils.applyTd(ws, 13, 3, 1, 3, null);
      ExcelTableUtils.applyTd(ws, 13, 6, 1, 2, null);

      ExcelTableUtils.applyTd(ws, 14, 0, 1, 1, title.title16());
