...
public class CreateExcelService {
  ...
  public void createExcel1() {
    ...
    try (OutputStream os = new FileOutputStream("output1.xlsx");
      ...
      ExcelTableUtils.titleStyleSetter(ws, 0, 0, 1, totalColSize).fontSize(18).set();
      ws.value(0, 0, "Title");
  ...
  public void createExcel3() {
    ...
    try (OutputStream os = new FileOutputStream("output3.xlsx");
      ...
      ExcelTableUtils.applyTh(ws, 2, 0, 1, 1, title.title7());
      ExcelTableUtils.applyTd(ws, 2, 1, 1, 7, content.data7());

      ExcelTableUtils.applyTh(ws, 3, 0, 1, 1, title.title8());
      ExcelTableUtils.applyTd(ws, 3, 1, 1, 3, content.data8());
      ExcelTableUtils.applyTh(ws, 3, 4, 1, 1, title.title9());
      ExcelTableUtils.applyTd(ws, 3, 5, 1, 3, content.data9());

      ExcelTableUtils.applyTh(ws, 4, 0, 1, 1, title.title10());
      ExcelTableUtils.applyTd(ws, 4, 1, 1, 3, content.data10());
      ExcelTableUtils.applyTh(ws, 4, 4, 1, 1, title.title11());
      ExcelTableUtils.applyTd(ws, 4, 5, 1, 3, content.data11());

      ExcelTableUtils.applyTh(ws, 5, 0, 1, 1, title.title12());
      ExcelTableUtils.applyTd(ws, 5, 1, 1, 3, content.data12());
      ExcelTableUtils.applyTh(ws, 5, 4, 1, 1, title.title13());
      ExcelTableUtils.applyTd(ws, 5, 5, 1, 3, content.data13());

      ExcelTableUtils.applyTh(ws, 6, 0, 1, 1, title.title14());
      ExcelTableUtils.applyCustomTd(ws, 6, 1, 1, 3, content.data14(), CustomStyle.style4());
      ExcelTableUtils.applyTh(ws, 6, 4, 1, 1, title.title15());
      ExcelTableUtils.applyTd(ws, 6, 5, 1, 1, content.data15());
      ExcelTableUtils.applyTh(ws, 6, 6, 1, 1, title.title16());
      ExcelTableUtils.applyTd(ws, 6, 7, 1, 1, content.data16());

      ExcelTableUtils.applyTh(ws, 7, 0, 1, totalColSize, title.title17());
      ExcelTableUtils.applyCustomTd(
          ws, 8, 0, 1, totalColSize, content.data17(), CustomStyle.style1());
      ExcelTableUtils.applyCustomTd(
          ws, 9, 0, 1, totalColSize, content.data17(), CustomStyle.style1());
      ExcelTableUtils.applyCustomTd(
          ws, 10, 0, 1, totalColSize, content.data17(), CustomStyle.style2());
      ExcelTableUtils.applyCustomTd(
          ws, 11, 0, 1, totalColSize, content.data17(), CustomStyle.style3());

      ExcelTableUtils.applyTh(ws, 12, 0, 1, 8, title.title18());

      ExcelTableUtils.applyTd(ws, 13, 0, 1, 1, title.title19());
      ExcelTableUtils.applyTd(ws, 13, 1, 1, 2, null);
      ExcelTableUtils.applyTd(ws, 13, 3, 1, 3, null);
      ExcelTableUtils.applyTd(ws, 13, 6, 1, 2, null);

      ExcelTableUtils.applyTd(ws, 14, 0, 1, 1, title.title20());
  ...
  public void createExcel4() {
    ...
    try (OutputStream os = new FileOutputStream("output4.xlsx");
      ...
      ExcelTableUtils.applyCustomTd(ws, 8, 1, 1, 3, content.data14(), CustomStyle.style4());
      ...
      ExcelTableUtils.applyTh(ws, 9, 0, 1, totalColSize, title.title17());
      ExcelTableUtils.applyCustomTd(
          ws, 10, 0, 1, totalColSize, content.data17(), CustomStyle.style1());
      ExcelTableUtils.applyCustomTd(
          ws, 11, 0, 1, totalColSize, content.data17(), CustomStyle.style1());
      ExcelTableUtils.applyCustomTd(
          ws, 12, 0, 1, totalColSize, content.data17(), CustomStyle.style2());
      ExcelTableUtils.applyCustomTd(
          ws, 13, 0, 1, totalColSize, content.data17(), CustomStyle.style3());

      ExcelTableUtils.applyTh(ws, 14, 0, 1, 8, title.title18());
